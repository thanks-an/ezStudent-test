<template>
  <div class="class-list">
    ...
    <ClassTable :classes="paginatedClasses" :offset="(currentPage - 1) * 15" @delete="deleteClassWrapper" />
...
export default {
  ...
  setup() {
    const { paginatedClasses, currentPage, totalPages, nextPage, prevPage, deleteClassWrapper, setupEventListeners, cleanupEventListeners } = useClasses()
